    ...
    <div className='section-card'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-2'>
        <label className='uma-label col-span-3'>
          <span className='font-base'>Scenario</span>
          <Select
          ...
          <Tooltips>
            {
              "Select the scenario you are currently playing.\n\
        ...
        <label className='uma-label col-span-3'>
          <span className='font-base'>Sleep Time Multiplier</span>
          <Input
            className='w-24'
            step={0.1}
            type='number'
        ...
        <label className='uma-label'>
          ...
          <Tooltips>
            If enabled bot will use ADB to connect to your emulator. You need to
            find the device ID which is the IP address of your emulator and its
            ADB port and enter it correctly as IP:Port.
          </Tooltips>
        </label>
        ...
        <label className={`uma-label ${use_adb ? '' : 'disabled'}`}>
          ...
          <Tooltips>
            Needs to be in the format of "IP:Port", example 127.0.0.1:5555
          </Tooltips>
          <Input
            type='text'
            className='w-48'
        ...
        <label className='uma-label'>
          ...
          <Tooltips>
            Uses GPU acceleration for EasyOCR if available. Disable this if GPU
            OCR causes crashes or your environment does not support CUDA.
          </Tooltips>
        </label>
        <label className='col-span-3 uma-label'>
          <Checkbox
            ...
            onCheckedChange={() =>
              updateConfig('notifications_enabled', !notifications_enabled)
            }
          />
          <span className='font-base'>Enable Notification Sounds</span>
          <Tooltips>
            Enables sounds to play as notifications. You can use custom sounds
            by adding them to assets/notifications folder of the bot.
          </Tooltips>
        </label>
        <label
          className={`uma-label ${notifications_enabled ? '' : 'disabled'}`}
        >
          <div className='flex gap-2 items-center'>
            <span className='font-base'>Info Sound</span>
            <Tooltips>
              Plays for other things, currently unused (v1.3.44).
            </Tooltips>
          </div>
          <Select
        ...
        >
          <div className='flex gap-2 items-center'>
            <span className='font-base'>Error Sound</span>
            <Tooltips>Plays when the bot gets stuck.</Tooltips>
          </div>
          <Select
        ...
        >
          <div className='flex gap-2 items-center'>
            <span className='font-base'>Success Sound</span>
            <Tooltips>Plays when the bot has finished a run.</Tooltips>
          </div>
          <Select
        ...
        <label
          className={`uma-label ${notifications_enabled ? '' : 'disabled'} col-span-3`}
        >
          <div className='flex items-center gap-4'>
            <span className='font-base min-w-[160px]'>Notification Volume</span>
